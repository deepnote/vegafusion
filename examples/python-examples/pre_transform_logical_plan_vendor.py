...
# This example demonstrates how to use the `pre_transform_logical_plan_vendor` method to create a new
# spec with supported transforms pre-evaluated and generate vendor-specific SQL queries.
def main():
    spec = get_spec()
    schema = pa.schema(
        [
